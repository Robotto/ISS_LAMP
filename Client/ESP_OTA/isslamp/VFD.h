...
#define VDF_FLICKERLESS_MODE 0x0E
...
public:
	...
	//!RD 			21					Expendable - READ pin - pull low to read from VFD 						A2

	//RESET 		20					Reset VFD on high pulse													A3
	...
	VFD(/*int T0, int CS, int RD, int RESET,*/ int A_0, int WR, int VFD7, int VFD6, int VFD5, int VFD4, int VFD3, int VFD2, int VFD1, int VFD0);
