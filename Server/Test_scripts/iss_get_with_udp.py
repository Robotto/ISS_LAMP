...
from time import strptime, mktime, struct_time, time, ctime
...
#    return 'V\n%s\n%s\n%s\n%s\n%s\n%s\n%s' % (V_startUnix, V_mag, V_loc1, V_maxUnix, V_loc2, V_endUnix, V_loc3)
    return 'V\0%s\0%s\0%s\0%s\0%s\0%s\0%s' % (V_startUnix, V_mag, V_loc1, V_maxUnix, V_loc2, V_endUnix, V_loc3)
#     return 'VISIBLE'
  else:
#    return 'R\n%s\n%s\n%s\n%s\n%s\n%s' % (A_startUnix, A_loc1, A_maxUnix, A_loc2, A_endUnix, A_loc3)
...
tempIP='85.82.195.140'
UDPSock.sendto('READY', (tempIP, remotePort))
